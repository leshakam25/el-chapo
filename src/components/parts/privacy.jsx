    ...
    <div>
      <Box sx={{ color: "white" }}>
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          сетевому адресу https://el-chapo-grande.tilda.ws. <br /> 2.4.
          ...
          персональными данными. <br /> 2.8. Персональные данные – любая
          ...
          персональные данные, разрешенные для распространения). <br /> 2.10.
          Пользователь – любой посетитель веб-сайта
          https://el-chapo-grande.tilda.ws. <br /> 2.11. Предоставление
          персональных данных – действия, направленные на раскрытие персональных
          данных определенному лицу или определенному кругу лиц. <br /> 2.12.
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          направлено.
          <br /> 5.7.4 Согласие на обработку персональных данных, разрешенных
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          электронной почты Nilovigorek@yandex.ru с пометкой «Отказ от
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          защиты персональных данных; <br />– согласия Пользователей на
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          Nilovigorek@yandex.ru с пометкой «Актуализация персональных данных».{" "}
          <br />
          ...
          на электронный адрес Оператора Nilovigorek@yandex.ru с пометкой «Отзыв
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          сети Интернет по адресу https://el-chapo-grande.tilda.ws/privacy.
        </Typography>
      </Box>
    </div>
  );
