...
const Privacy = () => {
  return (
    <Box sx={{ color: "white" }}>
      ...
      <br />
      <Typography variant="body1" fontWeight="bold" fontFamily="Oswald">
        1. Общие положения{" "}
      </Typography>
      <br />
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        безопасности персональных данных, предпринимаемые ООО "МАНКИ КОМПАНИИ"
        ...
        https://el-chapo-grande.tilda.ws.
      </Typography>
      <br />
      <Typography variant="body1" fontWeight="bold" fontFamily="Oswald">
      ...
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        https://el-chapo-grande.tilda.ws. <br /> 2.4. Информационная система
        ...
        совершаемые с персональными данными. <br /> 2.8. Персональные данные –
        любая информация, относящаяся прямо или косвенно к определенному или
        определяемому Пользователю веб-сайта https://el-chapo-grande.tilda.ws.{" "}
        <br /> 2.9. Персональные данные, разрешенные субъектом персональных
        ...
        данные, разрешенные для распространения). <br /> 2.10. Пользователь –
        любой посетитель веб-сайта https://el-chapo-grande.tilda.ws. <br />{" "}
        ...
        лиц. <br /> 2.12. Распространение персональных данных – любые действия,
      ...
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        установлен Законом о персональных данных; <br />– требовать от оператора
        ...
        меры по защите своих прав; <br />– выдвигать условие предварительного
        согласия при обработке персональных данных в целях продвижения на рынке
        товаров, работ и услуг;
        <br /> – на отзыв согласия на обработку персональных данных; <br />–
        ...
        <br /> 4.2. Субъекты персональных данных обязаны: <br />– предоставлять
      ...
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        <br /> 5.4. Вышеперечисленные данные далее по тексту Политики объединены
        ...
        <br /> 5.6. Обработка персональных данных, разрешенных для
        распространения, из числа специальных категорий персональных данных,
        указанных в ч. 1 ст. 10 Закона о персональных данных, допускается, если
        соблюдаются запреты и условия, предусмотренные ст. 10.1 Закона о
        персональных данных.
        <br /> 5.7. Согласие Пользователя на обработку персональных данных,
        разрешенных для распространения, оформляется отдельно от других согласий
        ...
        <br /> 5.7.2 Оператор обязан в срок не позднее трех рабочих дней с
        ...
        <br /> 5.7.4 Согласие на обработку персональных данных, разрешенных для
      ...
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        данных.
        <br /> 6.3. Не допускается объединение баз данных, содержащих
        ...
        <br /> 6.6. При обработке персональных данных обеспечивается точность
      ...
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        договоров; <br />– предоставление доступа Пользователю к сервисам,
        информации и/или материалам, содержащимся на веб-сайте
        https://эльчапо.рф;
        <br /> – информирование Пользователя посредством звонка на мобильный
        телефон. <br />
        ...
        почты Nilovigorek@yandex.ru с пометкой «Отказ от уведомлений о новых
      ...
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        являются: <br />– уставные (учредительные) документы Оператора;
        ...
        https://эльчапо.рф или направленные Оператору посредством электронной
      ...
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        <br /> 9.2. Обработка персональных данных необходима для достижения
      ...
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        уведомление на адрес электронной почты Оператора Nilovigorek@yandex.ru с
        ...
        электронный адрес Оператора Nilovigorek@yandex.ru с пометкой «Отзыв
      ...
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        <br /> 12.2. Трансграничная передача персональных данных на территории
      ...
      <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
        ...
        Оператору с помощью электронной почты Nilovigorek@yandex.ru. <br />
        ...
        Интернет по адресу https://el-chapo-grande.tilda.ws/privacy.
      </Typography>
    </Box>
  );
};
