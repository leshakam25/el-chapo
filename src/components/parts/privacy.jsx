...
const Privacy = () => {
  return (
    <div>
      Политика в отношении обработки персональных данных <br /> 1. Общие
      ...
      персональных данных, предпринимаемые ООО "МАНКИ КОМПАНИИ" (далее –
      ...
      получить о посетителях веб-сайта https://el-chapo-grande.tilda.ws. 2.
      ...
      интернет по сетевому адресу https://el-chapo-grande.tilda.ws. 2.4.
      ...
      без использования дополнительной информации принадлежность персональных
      ...
      удаление, уничтожение персональных данных. 2.7. Оператор – государственный
      ...
      https://el-chapo-grande.tilda.ws. 2.9. Персональные данные, разрешенные
      ...
      посетитель веб-сайта https://el-chapo-grande.tilda.ws. 2.11.
      ...
      5.1. Фамилия, имя, отчество. 5.2. Номера телефонов. 5.3. Также на сайте
      ...
      на веб-сайте https://el-chapo-grande.tilda.ws; – информирование
      Пользователя посредством звонка на мобильный телефон. 7.2. Также Оператор
      ...
      Оператору письмо на адрес электронной почты Nilovigorek@yandex.ru с
      ...
      уставные (учредительные) документы Оператора; – федеральные законы, иные
      ...
      формы, расположенные на сайте https://el-chapo-grande.tilda.ws или
      ...
      «cookie» и использование технологии JavaScript). 8.4. Субъект персональных
      данных самостоятельно принимает решение о предоставлении его персональных
      данных и дает согласие свободно, своей волей и в своем интересе. 9.
      Условия обработки персональных данных 9.1. Обработка персональных данных
      осуществляется с согласия субъекта персональных данных на обработку его
      персональных данных. 9.2. Обработка персональных данных необходима для
      ...
      Российской Федерации на оператора функций, полномочий и обязанностей. 9.3.
      ...
      в соответствии с федеральным законом. 10. Порядок сбора, хранения,
      ...
      области защиты персональных данных. 10.1. Оператор обеспечивает
      ...
      на адрес электронной почты Оператора Nilovigorek@yandex.ru с пометкой
      ...
      Nilovigorek@yandex.ru с пометкой «Отзыв согласия на обработку персональных
      данных». 10.5. Вся информация, которая собирается сторонними сервисами, в
      ...
      Nilovigorek@yandex.ru. 14.2. В данном документе будут отражены любые
      ...
      https://el-chapo-grande.tilda.ws/privacy.
    </div>
  );
};
