    ...
    <div>
      <Box sx={{ color: "white" }}>
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          адресу https://el-chapo-grande.tilda.ws. 2.4. Информационная система
          ...
          https://el-chapo-grande.tilda.ws. 2.9. Персональные данные,
          ...
          https://el-chapo-grande.tilda.ws. 2.11. Предоставление персональных
        ...
        <br />
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          5.1. Фамилия, имя, отчество. 5.2. Номера телефонов. 5.3. Также на
          ...
          Метрика и Гугл Аналитика и других). 5.4. Вышеперечисленные данные
          далее по тексту Политики объединены общим понятием Персональные
          данные. 5.5. Обработка специальных категорий персональных данных,
          касающихся расовой, национальной принадлежности, политических
          взглядов, религиозных или философских убеждений, интимной жизни,
          Оператором не осуществляется. 5.6. Обработка персональных данных,
          ...
          органом по защите прав субъектов персональных данных. 5.7.1 Согласие
          на обработку персональных данных, разрешенных для распространения,
          Пользователь предоставляет Оператору непосредственно. 5.7.2 Оператор
          ...
          кругом лиц персональных данных, разрешенных для распространения. 5.7.3
          ...
          направлено. 5.7.4 Согласие на обработку персональных данных,
          разрешенных для распространения, прекращает свое действие с момента
          поступления Оператору требования, указанного в п. 5.7.3 настоящей
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          https://el-chapo-grande.tilda.ws; – информирование Пользователя
          посредством звонка на мобильный телефон. 7.2. Также Оператор имеет
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          сайте https://el-chapo-grande.tilda.ws или направленные Оператору
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          электронной почты Оператора Nilovigorek@yandex.ru с пометкой
          ...
          адрес Оператора Nilovigorek@yandex.ru с пометкой «Отзыв согласия на
        ...
        <Typography variant="body1" fontWeight="light" fontFamily="Oswald">
          ...
          федеральным законом. 14. Заключительные положения 14.1. Пользователь
          может получить любые разъяснения по интересующим вопросам, касающимся
          обработки его персональных данных, обратившись к Оператору с помощью
          электронной почты Nilovigorek@yandex.ru. 14.2. В данном документе
